// Dareloom Hub v2 — robust messy-sheet handling, auto-thumbs, new->old, pagination, pop ad on Watch
...
function showItem(it){
  ...
  if(!embed) p.innerHTML = '<div style="padding:20px;color:var(--muted)">Trailer not available</div>';
